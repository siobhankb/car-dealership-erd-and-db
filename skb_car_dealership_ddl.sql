--consider writing function to set up table...?
CREATE TABLE table_name(
	column1 data_type not null, -- not null means that this column cannot be empty
	foreign key(column1) references other_table(a_column)
);
